...
$.parser={auto:true,onComplete:function(_1){
    ...
    plugins: [   "tree", "combo", "combobox", "combotree"], parse: function (_2) {
...
},beforePageText:"صفحه",afterPageText:"از {pages}",displayMsg:"نمایش {from} تا {to} از {total}",nav:{first:{iconCls:"pagination-first",handler:function(){
...
var span=$("<span class=\"textbox\">"+"<input class=\"textbox-text\" autocomplete=\"off\">"+"<input type=\"hidden\" id=\"ParentId\" class=\"textbox-value\">"+"</span>").insertAfter(_45b);
...
var _908=$("<input type=\"hidden\" id=\"ParentId\" class=\"textbox-value\">").appendTo(_906);
_908.attr("name",name);
if(opts.disabled){
...
var opts=$(this).combogrid("options");
return row[opts.textField].toLowerCase().indexOf(q.toLowerCase()) == 0;
    //return row[opts.textField] != null ? row[opts.textField].toLowerCase().indexOf(q.toLowerCase()) == 0 : false;
}});
})(jQuery);
(function($){
function _9af(_9b0){
