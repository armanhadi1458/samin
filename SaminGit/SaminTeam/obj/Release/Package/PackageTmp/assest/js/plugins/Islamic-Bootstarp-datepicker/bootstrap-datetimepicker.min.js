...
! function (a) {
    ...
    var c = function (c, d) {
        var e, f, g, h, i, j, k, l = {},
            ...
            H = function () {
                ...
                if ("auto" === g && (g = f.top + 1.5 * o.height() >= a(window).height() + a(window).scrollTop() && o.height() + c.outerHeight() < f.top ? "bottom" : "bottom"), "auto" === h && (h = b.width() < f.left + o.outerWidth() / 2 && f.left + o.outerWidth() > a(window).width() ? "right" : "left"), "top" === g ? o.addClass("bottom").removeClass("top") : o.addClass("bottom").removeClass("top"), "right" === h ? o.addClass("pull-right") : o.removeClass("pull-right"), "relative" !== b.css("position") && (b = b.parents().filter(function () {
                ...
                o.css({                   
                    ...
                    left: "left" === h ? b === c ? 0 : e.left : "auto",//0 : "auto",// ,
    ...
    a.fn.datetimepicker = function (b) {
        ...
        icons: {
            ...
            next: "glyphicon glyphicon-arrow-left",
